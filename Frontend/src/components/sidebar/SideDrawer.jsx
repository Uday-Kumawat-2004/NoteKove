            ...
            item.childs ? (
              ...
              <div key={i} className="flex flex-col gap-1">
                ...
                <div
                  ...
                  className={`flex flex-col ml-4 gap-1 transition-all duration-500
                ...
                >
                  ...
                  {labels?.map(label=>(
                    ...
                    <NavLink
                      ...
                      className={({isActive})=>
                        ...
                        `ml-6 rounded-md px-2 py-1 text-gray-200
                  ...
                  <div
                    ...
                    className="flex items-center text-gray-300 cursor-pointer mt-2 px-2 py-1 rounded-md border border-dashed border-[#25879f] hover:bg-[#25879f33]"
            ...
            (
              ...
              <NavLink
                ...
                className={({isActive})=>
                  ...
                  `flex items-center rounded-lg text-white transition-all duration-500
