...
export default function NoteCard({ note }) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full text-gray-200 text-md whitespace-pre-wrap break-words overflow-hidden max-h-140 overflow-y-hidden relative">
        {hasChecklist ? (
      ...
      <div className="flex items-center justify-center w-full">
        <button
        onClick={toggletrash}
          className="text-gray-200 px-10 py-1 border-none hover:cursor-pointer 
